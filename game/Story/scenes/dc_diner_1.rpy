label dc_diner_1:
    ...
    #todo this asset: https://www.daz3d.com/american-diner-60s
    ...
    scene black at topleft with dis #todo show mary in goth-metal-outfit
...
label dc_diner_1_talk_to_ragnar_and_iggy:
    ...
    scene black at topleft with dis #todo grinning and pointing at camera
    m "Exactly!"
    return